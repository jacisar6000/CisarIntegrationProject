...
<<<<<<< HEAD
    ...
    // resources.
    // The main set-up is a main menu. By entering the number of your choice,
    // the
    // option will
    // appear.
    ...
    // String (str) represents character strings. Strings are constant and
    // cannot be
    // changed after
    // being created.
=======
...
>>>>>>> branch 'master' of https://github.com/jacisar6000/CisarIntegrationProject
    ...
    try {
      ...
      System.out.println(
          "| 1. Basic Calculator                                      |");
      System.out.println(
          "| 2. Use relational and conditional operators              |");
      System.out.println(
          "| 3. Increment and decrement operators                     |");
      System.out.println(
          "| 4. compareTo() and equalTo() strings                     |");
      System.out.println(
          "| 5. Math/Random class example                             |");
      System.out.println(
          "| 6. Switch statements                                     |");
      System.out.println(
          "| 7. Casting example                                       |");
      ...
      System.out.println(
          "| 9. Escape equences                                       |");
      System.out.println(
          "| 10. View code: Create a method with arguments and return |");
      System.out.println(
          "| 11. View code: 3 string methods                          |");
      System.out.println(
          "| 12. For Loop                                             |");
      System.out.println(
          "| 13. Do/While Loop                                        |");
      ...
      System.out.println(
          "| 17. Smallest integer of an array                         |");
      System.out.println(
          "| 18. Sum of array values                                  |");
      System.out.println(
          "| 19. Polymorphism code                                    |");
      System.out.println(
          "| 20. Overloading a method                                 |");
      System.out.println(
          "| 21. Inheritance and its benefits                         |");
      System.out.println(
          "| 22. Enchanced for loop                                   |");
      System.out.println(
          "| 23. Super to access obj/constructor                      |");
      System.out.println(
          "| 24. Multidimensional array                               |");
      System.out.println(
          "| 25. Searching a 2-D array                                |");
      System.out.println(
          "| 26. Rubric class                                         |");
      System.out.println(
          "------------------------------------------------------------");
...
>>>>>>> branch 'master' of https://github.com/jacisar6000/CisarIntegrationProject
            ...
            if (num == 1) {
              ...
              // Operator Precedence:
              // In Java, operator precedence is when two operators share an
              // operand the
              // operator with
              ...
              System.out.println(input1 + input2); // (input1 + input2) is an
              // argument
            } else if (num == 2) {
              System.out
                  .println("Enter two decimal numbers to find the difference.");
              System.out.println("Number 1: ");
              double input1 = sc.nextDouble();
              System.out.println("Number 2: ");
              double input2 = sc.nextDouble();
              ...
              System.out
                  .println("Enter two decimal numbers to find the product.");
              System.out.println("Number 1: ");
              double input1 = sc.nextDouble();
              System.out.println("Number 2: ");
              double input2 = sc.nextDouble();
              ...
              System.out
                  .println("Enter two decimal numbers to find the quotient.");
              System.out.println("Number 1: ");
              double input1 = sc.nextDouble();
              System.out.println("Number 2: ");
              double input2 = sc.nextDouble();
        ...
        if (mainMenuChoice == 2) {
          ...
          try {
            System.out.println(
                "In the box below are relational and conditional statements.");
            ...
            if (input1 <= input2) {
              System.out
                  .println(input1 + " is less than or equal to " + input2);
            }
            if (input1 >= input2) {
              System.out
                  .println(input1 + " is greater than or equal to " + input2);
            }
            if (input1 != input2) {
        ...
        if (mainMenuChoice == 3) {
          ...
          System.out.println(d--); // outputs 8, -- decrements the value of d
          // and then returns d
        ...
        if (mainMenuChoice == 4) {
          ...
          try {
            System.out.println(
                "Enter 1 or 2 to compare strings or to see if the strings are equal.");
            ...
            if (value == 2) {
              ...
              System.out.println(
                  "You chose to see if the strings are equal to one another.");
              // Could not get this test to work
              // str1.equals(str2);
              // str1 = String("true1").equals("true1"); // this test is true,
              // both strings
              // have the
              // same value
...
>>>>>>> branch 'master' of https://github.com/jacisar6000/CisarIntegrationProject
            ...
            System.out.println(
                "| 2. Find the sine, cosine and tangent of a degree   |");
            System.out.println(
                "------------------------------------------------------");
            ...
            if (mathChoice == 1) {
              ...
              int value = rand.nextInt(4);
              int value2 = rand.nextInt(4);
              System.out.println(value + " to the " + value2 + "th power is "
            ...
            if (mathChoice == 2) {
              ...
              int degree = rand.nextInt(360); // 360 is the limit
              System.out.println(
                  "The sine of " + degree + "° is " + Math.sin(degree));
              System.out.println(
                  "The cosine of " + degree + "° is " + Math.cos(degree));
              System.out.println(
                  "The tangent of " + degree + "° is " + Math.tan(degree));
            }
          } catch (Exception e) {
            System.out.println("Incorrect input");
            break;
